...
// Tx returns a wrapped transaction (acmutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (acmutil.Tx) for all
...
// instead provides easy access to wrapped versions (acmutil.Tx) of them.
