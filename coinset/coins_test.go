...
import (
	...
	"github.com/Actinium-project/acmutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    acmutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() acmutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value acmutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = acmutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = acmutil.NewTxFromBytes(testSimpleCoinTxBytes)
