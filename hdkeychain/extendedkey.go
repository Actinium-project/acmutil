...
import (
	...
	"github.com/Actinium-project/acmutil/base58"
)
...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := acmutil.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*acmutil.AddressPubKeyHash, error) {
	pkHash := acmutil.Hash160(k.pubKeyBytes())
	return acmutil.NewAddressPubKeyHash(pkHash, net)
}
