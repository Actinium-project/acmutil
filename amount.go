...
// units, "1eN ACM" is returned, where N is the AmountUnit.
func (u AmountUnit) String() string {
	...
	case AmountSatoshi:
		return "Satoshi"
	default:
		return "1e" + strconv.FormatInt(int64(u), 10) + " ACM"
	}
}
...
//
// NewAmount is for specifically for converting ACM to Satoshi.
// For creating a new Amount with an int64 value which denotes a quantity of Satoshi,
// do a simple type conversion from type int64 to Amount.
// See GoDoc for example: http://godoc.org/github.com/Actinium-project/acmutil#example-Amount
